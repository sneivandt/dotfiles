...
Shell scripts in this project are **thin wrappers** (~150 lines) that bootstrap the Rust binary. All task logic lives in `cli/src/tasks/bootstrap/` and `cli/src/tasks/configure/`.
...
- Never add task logic to shell scripts — use `cli/src/tasks/bootstrap/` or `cli/src/tasks/configure/`
