...
**Implementation**: `cli/src/tasks/repository/sparse_checkout.rs`
...
**Implementation** (in `cli/src/tasks/repository/sparse_checkout.rs`):
...
- **`cli/src/tasks/repository/sparse_checkout.rs`** - Sparse checkout task implementation
