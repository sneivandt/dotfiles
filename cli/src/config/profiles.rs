...
pub struct Profile {
    ...
    pub name: String,
    /// Categories that are active for this profile (e.g., `[Category::Base, Category::Linux]`).
    pub active_categories: Vec<Category>,
    /// Categories that are excluded for this profile (e.g., `[Category::Windows, Category::Desktop]`).
