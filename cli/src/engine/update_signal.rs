//! Typed signal shared between [`crate::phases::repository::update::UpdateRepository`] and
...
impl UpdateSignal {
    ...
    ///
    /// Called by [`crate::phases::repository::update::UpdateRepository`] after a successful
    ...
    ///
    /// Called by [`crate::phases::repository::reload_config::ReloadConfig`] to decide whether
