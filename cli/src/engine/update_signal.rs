//! Typed signal shared between [`crate::tasks::bootstrap::update::UpdateRepository`] and
...
impl UpdateSignal {
    ...
    ///
    /// Called by [`crate::tasks::bootstrap::update::UpdateRepository`] after a successful
    ...
    ///
    /// Called by [`crate::tasks::bootstrap::reload_config::ReloadConfig`] to decide whether
