...
macro_rules! test_load_missing_returns_empty {
    ($loader:path) => {
        ...
        fn load_missing_file_returns_empty() {
            crate::runtime::config_support::test_helpers::assert_load_missing_returns_empty(
                $loader,
            );
        }
    };
...
macro_rules! test_load_missing_unfiltered_returns_empty {
    ($loader:path) => {
        #[test]
        fn load_missing_file_returns_empty() {
            crate::runtime::config_support::test_helpers::assert_load_missing_unfiltered_returns_empty(
                $loader,
            );
        }
    };
